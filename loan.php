...
<head>
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        $.post("test.php",{counter:c_counter},function(data){
            $("#result").html(data);
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="customerindex.php">DASHBOARD</a>
                    </li>
                    <li>
                        <a href="cprofile.php">MY PROFILE</a>
                    </li>
                    <li>
                        <a href="loan.php">CALCULATE LOAN</a>
                    </li>
                    <li>
    ...
    <div class="container">
		<form class="form-horizontal"  method="post"  style="background-color: white;" action="form.php">
              ...
              <div class="row">
                  <div class="col-md-5 col-sm-5 col-xs-12 style="float: left;">  
                		  <div class="form-group">
                		      <label for="Name" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-4 control-label">First Name</label>
                		  ...
                		  <div class="form-group">
                              <label for="address" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-4 control-label">Last Name</label>
                            <div class="col-md-6 col-sm-6 col-md-offset-1 col-xs-12 col-xs-offset-0">
                              <input type="text" class="form-control"  value="<?php echo $address_session; ?>"  id="address" name="address" readonly="true" />
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                  		    ...
                  		    <div class="col-md-6 col-md-offset-1 col-xs-12 col-sm-6 col-xs-offset-0">
                  		      <input type="text" class="form-control"  value="<?php echo $phone_session; ?>"  id="phonenumber" readonly="true"  name="phonenumber" />
                  		    </div>
                		  </div>
                      ...
                      <div class="form-group" >
                            <label for="dddownpayment" class="col-md-4 col-sm-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Select Down Payment</label>
                                <div class="col-md-6 col-sm-6 col-md-offset-1 col-xs-12 col-xs-offset-0">
                                     <select class="form-control "  onchange="calculate()" id="dddownpayment" name="dddownpayment" >
                      ...
                      <div class="form-group" >
                           <label for="ddmipfinanced" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Select MIP Financed</label>
                                <div class="col-md-6 col-sm-6 col-md-offset-1 col-xs-12  col-xs-offset-0">
                                     <select class="form-control " onchange="calculate()"  id="ddmipfinanced" name="ddmipfinanced">
                      ...
                      <div class="form-group" >
                       <label for="loantypef" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Loan Type</label>
                            <div class="col-md-6 col-sm-6 col-md-offset-1 col-xs-12 col-xs-offset-1">
                                 <select class="form-control "  id="loantypef" name="loantypef">
                      ...
                      <div class="form-group" >
                       <label for="loanterm" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Loan Term (Years)</label>
                            <div class="col-md-6 col-md-offset-1 col-xs-12 col-sm-6 col-xs-offset-1">
                                 <select class="form-control " onchange="calculate()"  id="loanterm" name="loanterm">
                                    <option value=30 >30</option>
                                    <option value=25 >25</option>
                                    <option value=20 >20</option>
                                    <option value=15 >15</option>
                      ...
                      <div class="form-group" >
                       <label for="interestrate" class="col-md-4 col-md-offset-1  col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Interest Rate</label>
                            <div class="col-md-6 col-md-offset-1 col-sm-6 col-xs-12 col-xs-offset-1">
                                 <select class="form-control " onchange="calculate()"  id="interestrate" name="interestrate">
                      ...
                      <div class="form-group" >
                       <label for="ddpropertytaxes" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Select Property Taxes</label>
                            <div class="col-md-6 col-md-offset-1 col-xs-12 col-xs-offset-1 com-sm-6">
                                 <select class="form-control " onchange="calculate()" id="ddpropertytaxes" name="ddpropertytaxes">
                      ...
                      <div class="form-group" >
                       <label for="ddhomeownerinsper" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Select Home Owner Insurance</label>
                            <div class="col-md-6 col-md-offset-1 col-sm-6 col-xs-12 col-xs-offset-1">
                                 <select class="form-control " onchange="calculate()" id="ddhomeownerinsper" name="ddhomeownerinsper">
                      ...
                      <div class="form-group" >
                       <label for="ddmmi" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-3  control-label">Select MMI </label>
                            <div class="col-md-6 col-md-offset-1 col-sm-6 col-xs-12 col-xs-offset-1">
                                 <select class="form-control" placeholder="this is fr mi" onchange="calculate()" id="ddmmi" name="ddmmi">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group" style="text-align: center;">
                                      <div class="col-md-6 col-md-offset-3  col-sm-6 col-sm-offset-4  col-xs-6 col-xs-offset-3 ">
                                       <input type="submit" name="btnpdf" id="btnpdf" style="padding: 10px" value="GENERATE PDF" class="btn btn-success">
                                      </div>
                        </div>            
 ...
 <form method="post" id="myform" style="background-color: white;margin-bottom: 20px;text-align: right;" onsubmit="return false"  action="loan.php"> <button id="btncalculate" name="btncalculate" style="margin-bottom: 10px;margin-right: 115px;padding: 15px" onclick="remningcshclosing()"  class="btn btn-success">CALCULATE LOAN</button></form>
