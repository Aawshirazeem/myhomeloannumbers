    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">My Home Loan</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Developer Zone</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"> <strong>There is no Place Like Home </strong>
					<br>
                        <strong>Lets Build Your Own With Us</strong>
                    </h2>
                    <hr>
