...
if(isset($_POST['btncalculate'])){
    echo"<script> alert('Please Login to Calculate Final Amount'); </script>";
    ?>
    <script >
...
<body>
    ...
    <div class="container">
		<form class="form-horizontal" id="myform"  method="post"  style="background-color: white;margin-bottom: 20px" action="">
              ...
              <div class="row">
                  <div class="col-md-5 col-sm-5 col-xs-12 style="float: left;">  
                		  ...
                		  <div class="form-group">
                		      <label for="phonenumber" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-4 control-label">Last Name.</label>
                		  ...
                		  <div class="form-group">
                		      <label for="address" class="col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1  col-xs-12 col-xs-offset-4 control-label">Phone No#</label>
                  		    <div class="col-md-6 col-sm-6 col-md-offset-1 col-xs-12 col-xs-offset-0">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group" style="text-align: center;">
                                      <div class="col-md-6 col-md-offset-3  col-sm-6 col-sm-offset-4  col-xs-6 col-xs-offset-3 ">
                                        <button id="btncalculate" name="btncalculate"   class="btn btn-success">Calculate Loan</button> 
